...
class Linkshare extends Module
{
    ...
    **/
    ...
    {
        $this->CI->admin_navigation->child_link('linkshare', 10, 'Networks', site_url('admincp/linkshare/listNetworks'));
        $this->CI->admin_navigation->child_link('linkshare', 20, 'Application Status', site_url('admincp/linkshare/listStatus'));
        $this->CI->admin_navigation->child_link('linkshare', 30, 'Categorii', site_url('admincp/linkshare/listCategories'));           
        $this->CI->admin_navigation->child_link('linkshare', 40, 'Site-uri', site_url('admincp/linkshare/listSites'));             
        ...
        $this->CI->admin_navigation->child_link('linkshare', 90, 'Logs Panel', site_url('admincp3/linkshare/logsPanel'));
