	...
	*/
	function get_produse_by_mid ($params) {
		$row = array();
                ...
                if(isset($params['id_site']))  $this->db->where('id_site',$params['id_site']);
                if(isset($params['mid']))  $this->db->where('mid',$params['mid']);
                if(isset($params['cat_creative_id']))  $this->db->where('cat_creative_id',$params['cat_creative_id']);
                if(isset($params['cat_creative_name']))  $this->db->where('cat_creative_name',$params['cat_creative_name']);
		$result = $this->db->get('linkshare_produs');
