		...
		?>
			<tr>			
				...
				<td align="center"><?=$row['productname'];?></td>			
                                ...
                                <td align="center">
                                    <?php if($row['available'] == 'yes') { ?><a href="<?= 'admincp3/linkshare/changeTempProductStatus/'.$row['id'].'/'.$row['id_site'].'/'.$row['cat_creative_id'].'/'.$row['mid'].'/'.$row['linkid'].'/'.$url; ?>"><img src="<?=branded_include('images/ok.png');?>"/></a> <?php } ?>
                                    <?php if($row['available'] == 'no'){ ?><a href="<?= 'admincp3/linkshare/changeTempProductStatus/'.$row['id'].'/'.$row['id_site'].'/'.$row['cat_creative_id'].'/'.$row['mid'].'/'.$row['linkid'].'/'.$url; ?>"><img src="<?=branded_include('images/ko.png');?>"/></a> <?php } ?>
                                </td>                                
