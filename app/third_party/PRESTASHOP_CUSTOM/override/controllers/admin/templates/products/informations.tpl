...
<div id="product-informations" class="panel product-tab">
	...
	<div class="form-group">
		<label class="control-label col-lg-3 required" for="extern_link">
			<span class="label-tooltip" data-toggle="tooltip"
			title="{l s='Link from Linkshare, CJ, etc..'}">
				{$bullet_common_field} {l s='Extern Link'}
			</span>
		</label>
		<div class="col-lg-5">
			<input type="text" id="extern_link" name="extern_link" value="{$product->extern_link|htmlentitiesUTF8}" />
		</div>
	</div>
