	...
	*/
	function get_categorii ($filters) {
            ...
            if (isset($filters['limit'])) {
                ...
                if(isset($filters['mid'])) $this->db->where('mid',$filters['mid']); 
                if(isset($filters['mid'])) $this->db->order_by('cat_id'); else $this->db->order_by('id');
	...
	*/
	function get_categorii_parse ($filters) {
        ...
        function parse_categorii($params) {            
            if(isset($params[0]['limit'])) $limit = $params[0]['limit']; else $limit = 10;
            if(isset($params[0]['offset']))    $offset = $params[0]['offset']; else $offset = 0;
