...
class Linkshare extends Module
{
    ...
    **/
    ...
    {
        $this->CI->admin_navigation->child_link('linkshare', 10, 'Site-uri', site_url('admincp/linkshare/listSites'));
        ...
        $this->CI->admin_navigation->child_link('linkshare', 40, 'Advertiseri', site_url('admincp/linkshare/siteAdvertisers'));
        $this->CI->admin_navigation->child_link('linkshare', 50, 'Categorii', site_url('admincp/linkshare/listCategories'));
